...
LangString LAMEXP_LANG_LOCKEDLIST_TEXT     ${LANG_RUSSIAN} "Проверка на наличие работающих копий LameXP."
...
LangString LAMEXP_LANG_LOCKEDLIST_COLHDR2  ${LANG_RUSSIAN} "Процесс"
LangString LAMEXP_LANG_UNINST_PERSONAL     ${LANG_RUSSIAN} "Хотите ли вы также удалить свои персональные настройки?"
...
LangString LAMEXP_LANG_LINK_UNINSTALL      ${LANG_RUSSIAN} "Деинсталлировать"
LangString LAMEXP_LANG_LINK_FAQ            ${LANG_RUSSIAN} "Часто задаваемые вопросы"
LangString LAMEXP_LANG_LINK_MANUAL         ${LANG_RUSSIAN} "Руководство пользователя"
LangString LAMEXP_LANG_PRERELEASE_WARNING  ${LANG_RUSSIAN} "Вы собираетесь установить ДЕМО (предварительную) версию LameXP!"
